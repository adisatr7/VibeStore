package com.example.innotechstore.data.repository
...
import com.example.innotechstore.data.remote.retrofit.ApiService
import com.example.innotechstore.model.LoginResponse
import com.example.innotechstore.model.ProductResponseItem
import com.example.innotechstore.model.UserResponse
...
class InnotechStoreRepository private constructor(
    ...
    fun getCurrentLocation() : LiveData<LatLng?> {
        ...
        fusedLocationClient.lastLocation.addOnSuccessListener { location ->
            if (location != null) {
                Log.d("InnotechStoreRepository", "Location: ${location.latitude}, ${location.longitude}")
                liveData.value = LatLng(location.latitude, location.longitude)
            } else {
                Log.d("InnotechStoreRepository", "No location found")
            }
        }
        return liveData
    }
